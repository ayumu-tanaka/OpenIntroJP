...
% latin1 inputenc and english babel removed for LuaLaTeX + Japanese support
...
\usepackage{multicol}
\usepackage{textcomp}
% txfonts removed: conflicts with LuaLaTeX Japanese fonts
\usepackage{listings}
\usepackage{tikz}
\usepackage{array}
\usepackage{wasysym}
...
% Note
\newcommand{\Note}[1]{
\rule{2.5cm}{0.25pt} \\ \textit{\footnotesize{\textcolor{rubineRed}{注：} \textcolor{darkerGray}{#1}}}}

% Remember
\newcommand{\Remember}[1]{\textit{\scriptsize{\textcolor{orange}{復習：} #1}}}
...
% slide 1: normal item (question), slide 2: orange item (answer)
\newcommand{\solnMult}[1]{
\item \alt<2->{\orange{#1}}{#1}
}
